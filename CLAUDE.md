...
- [ ] **[VOR Simulation]** Kollabierbare Sidebar (app-weit): Toggle-Button klappt `Sidebar.jsx` von 220px auf ~48px (Icon-only) zusammen. Zustand in `useAppStore` (`sidebarCollapsed`). Spart Platz auf allen Seiten, besonders kritisch für das Simulation-Layout. Design-Referenz: `docs/Design-System.html` prüfen. Muss vor `/simulation` implementiert sein.
